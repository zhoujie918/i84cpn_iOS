...
class CPAddressSearchController: UIViewController,addressSearchDelegate {
    ...
    override func viewDidLoad() {
        ...
        let homeTestCtl=CPHomePageView()
        if homeTestCtl.schoolValue != nil{
            print("home:",homeTestCtl.schoolValue)
        }
    ...
    override func viewWillDisappear(animated: Bool) {
        if self.addressSearchView.addressTableView.indexPathForSelectedRow != nil {
            self.addressSearchView.addressTableView.deselectRowAtIndexPath(self.addressSearchView.addressTableView.indexPathForSelectedRow!, animated: true)
        }
    }
