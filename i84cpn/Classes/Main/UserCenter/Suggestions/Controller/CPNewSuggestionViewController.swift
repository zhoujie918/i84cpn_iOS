...
class CPNewSuggestionViewController: CMBaseViewController, UIAlertViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, CPPhotoCollectionViewDelegate {

    override func viewDidLoad() {
        super.viewDidLoad()
        title = "意见反馈"
        view.addSubview(newSuggestionView)
        newSuggestionView.frame = self.view.frame
        newSuggestionView.frame.size.height = newSuggestionView.frame.size.height - 64
...
//            img = imageWithImage(img, newSize: CGSizeMake(375, 375))
