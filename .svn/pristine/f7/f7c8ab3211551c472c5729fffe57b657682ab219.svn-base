...
class CPPassengerInfoViewController: CMBaseViewController, UITableViewDataSource, UITableViewDelegate {
...
//                print(error)
//            })
            cell.headImageView.sd_setImageWithURL(Constants.getSDWebImageURLWithImageName(imageName!), placeholderImage: UIImage(named: "img_default"))
        } else {
            cell.headImageView.image = UIImage(named: "img_default")
        }
        return cell
    }
