...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *menuLableTop;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *menuLableBottom;
...
- (void)viewDidLoad {
    ...
    self.title = @"付款结果";
    self.imageTop.constant = 55 * SCALE_HEIGHT;
    self.imageLeft.constant = 103 * SCALE_WIDTH;
    self.getBabiTop.constant = 44 * SCALE_HEIGHT;
    self.menuHeight.constant = 60 * SCALE_HEIGHT;
    //隐藏巴币相关视图，临时将订单视图上移
    self.menuLableTop.constant = -30;
    self.menuLableBottom.constant = 100;
