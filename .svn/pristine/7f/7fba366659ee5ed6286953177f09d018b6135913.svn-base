...
//        }
        ...
        schoolDropDown.pullDownButton.addTarget(self, action: #selector(CPHomePageView.schoolPullUp), forControlEvents: UIControlEvents.TouchUpInside)
        gradeDropDown.pullDownButton.addTarget(self, action: #selector(CPHomePageView.gradePullUp), forControlEvents: UIControlEvents.TouchUpInside)
    }
    
    func schoolPullUp(){
        if schoolDropDown.isShown==false {
            if gradeDropDown.isShown==true{
                gradeDropDown.showOrHide()
            }
        }
    }
    
    func gradePullUp(){
        if gradeDropDown.isShown==false {
            if schoolDropDown.isShown==true{
                schoolDropDown.showOrHide()
            }
        }
    }
